...
// Processing <s>
// Grammar: <s> ::= [CONNECTOR #getEword# #gen(CONNECTOR)#] <noun> #getEword# SUBJECT #gen(ACTOR)# <after_subject>
// Done by: Adam Salter
void s() {
...
// Grammar: <after_subject> ::= <verb> #getEword# #gen(ACTION)# <tense> #gen(TENSE)# PERIOD | <noun> #getEword# <after_noun>
// Done by: Adam Salter
void after_subject() {
...
// Grammar: <after_noun> ::= <be> #gen(DESCRIPTION)# #gen(TENSE)# PERIOD | DESTINATION <verb> #getEword# #gen(ACTION)# <tense> #gen(TENSE)# PERIOD | OBJECT <after_object>
// Done by: Adam Salter
void after_noun() {
...
map<string, string> Lexicon; // Lexicon for translations
ofstream outFile;           // Output file stream
string saved_lexeme;        // Current lexeme being processed
string saved_E_word;        // Current English word being processed
...
void gen(const string& line_type) {
    ...
    outFile << line_type << ": ";
    if (line_type == "TENSE") {
        outFile << currWord; // TENSE uses tokens
    } else {
...
void getNextToken() {
    ...
    scanner(token_type, saved_lexeme);
